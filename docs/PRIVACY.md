...
| ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| Conversión y consulta de moneda (Frankfurter)           | Al convertir un registro con tasa automática; en `Más → Consulta de divisas`, si falta una tasa automática del día o si el usuario pulsa actualizar                                                               | Códigos de moneda y fecha; no se envía el importe consultado ni ningún registro financiero | `api.frankfurter.dev` (API pública)                    |
