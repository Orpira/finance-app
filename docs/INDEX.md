...
- [ADR-033 — Adicionales cuentan como Ingresos, no como Ganancia](./adr/ADR-033-ADDITIONALS-INCOME-NOT-PROFIT.md) (superseded en parte por ADR-035)
- [ADR-035 — Ingresos excluye Adicionales; solo el principal cuenta como Ingresos y Ganancia](./adr/ADR-035-INCOME-EXCLUDES-ADDITIONALS.md)
