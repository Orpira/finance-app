...
import { sendTextRequestSchema } from '../../../server/communication/contracts/outboundMessage.js'
...
import { sendTextMessage } from '../../../server/communication/services/outboundMessageService.js'
